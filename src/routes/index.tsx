    ...
    <PageShell>
      ...
      <section className="border-t-2 border-foreground bg-foreground text-background">
        <div className="mx-auto grid max-w-[1600px] grid-cols-1 items-stretch md:grid-cols-4">
          ...
          <div className="relative flex items-center justify-center overflow-hidden bg-foreground p-4 md:col-span-1 md:p-0">
            <img
              src={IMG.instructor}
              alt="Lena Faber instructing"
              className="h-auto w-[120%] max-w-none shrink-0 object-contain"
              loading="lazy"
            />
          </div>
        </div>
